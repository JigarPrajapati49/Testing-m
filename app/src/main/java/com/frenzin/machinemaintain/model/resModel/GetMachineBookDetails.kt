...
data class GetMachineBookDetails (
    @SerializedName("data"          ) var data        : MachineBook?   = MachineBook(),
    @SerializedName("next_page_url" ) var nextPageUrl : String? = null,
    @SerializedName("prev_page_url" ) var prevPageUrl : String? = null
)

data class MachineBook (
    @SerializedName("current_page"   ) var currentPage  : Int?             = null,
    @SerializedName("data"           ) var data         : ArrayList<MachineBookDetails>  = arrayListOf(),
